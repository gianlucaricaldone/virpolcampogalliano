  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const dataToSubmit = {
        ...
        costo_iscrizione: formData.costo_iscrizione ? parseFloat(formData.costo_iscrizione) : null,
        numero_squadre_max: formData.numero_squadre_max ? parseInt(formData.numero_squadre_max) : null,
